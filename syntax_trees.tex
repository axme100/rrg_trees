...
\begin{document}
\section*{a.) Mi abuela conoció a Juan Pérez en su juventud}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\begin{comment}
%El médico ya vio varios pacientes 
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREb]{
...
\\
\end{comment}
%El médico ya vio varios pacientes (new)
\psset{treesep=2ex}
\SENTENCE{%
  \CLAUSE{%
    \CORE[COREb]{%
...
\\
\\
%Los bomberos salieron de la estación
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\\
% A las niñas nos escondían adentro de la casa
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
% Escoge al gatito que más te guste
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
