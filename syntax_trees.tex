  ...
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
        \skiplevels{2}
        \ARG{\WORD(NP){{[yo]}}}
        \rPERIPH[b]{1}{\rnode{FA}{FA}}{\WORD{no}}%
        \NUC{sacrificaré}
  ...
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
        ...
        \ARG{\WORD(NP){{*nos}}}
        \NUC{escondían}
        \ARG{\FanEnd{PP}{adentro de la casa}}
      }
    }
  }
\dolinks
...
\\
\newpage
\section*{Juan se olvidó del libro en la mesa}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Con estos lentes puedo ver los bichitos en las plantas}
\psset{treesep=2ex}
\lPERIPH[a]{3}{PP}{
	\CORE{
    \NUC[P]{Con}
...
\\
\newpage
\section*{El año pasado, los biólogos identificaron algunas de las especies}
\psset{treesep=2ex}
\lPERIPH[a]{3}{NP}{
	\CORE{
    \NUC[N]{El año pasado}
...
\\
\newpage
\section*{Saluda a la doctora a la entrada}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Nadie confía en ti desde el accidente}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Le acaricié la cabeza a Juan}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Tú tienes miedo de la obscuridad}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{En las mañanas saluda la doctora}
\psset{treesep=2ex}
\lPERIPH[a]{3}{PP}{
	\CORE{
    \NUC[P]{En}
...
\\
\newpage
\section*{Me saqué el suéter con dificultad}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Le estoy tejiendo una bufanda}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Silvia te mandó un abrazo conmigo}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{María vino de su casa al trabajo}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
...
\\
\newpage
\section*{Sofía depende de las semillas de chia para vivir}
\psset{treesep=2ex}
  \SENTENCE{
    \CLAUSE{
      \CORE[COREa]{
